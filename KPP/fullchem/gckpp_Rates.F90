...
! RCONST(735) = constant rate coefficient
  ...
  RCONST(882) = (GCARR_abc(7.1d-12,2.44d0,-666d0))
  RCONST(883) = (GCARR_abc(3.8d-13,-2.0d0,131.0d0))
  RCONST(884) = (2.44d-21)
  RCONST(885) = (3.1d-16)
  RCONST(886) = (GCARR_ac(8.89d-16,1723.0d0))
  RCONST(887) = (GCARR_ac(2.29d+14,-7621.0d0))
  RCONST(888) = (1.5d-11)
  RCONST(889) = (PHOTOL(2))
  RCONST(890) = (PHOTOL(3))
  RCONST(891) = (PHOTOL(1))
  ...
  RCONST(1066) = (PHOTOL(178))
  RCONST(1067) = (PHOTOL(179))
